        ...
        <th>Name</th><th>Email</th><th>PhoneNumber</th><th>Company</th><th>Category</th><th>Actions</th>
             ...
             <c:forEach var="contact" items="${contactList}">
                  <tr>
                      ...
                      <td>
                          <span class="glyphicon glyphicon-pencil" data-toggle="modal" data-target="#myModal3" onclick="getContactInfo(${contact.contactId})"></span>
                          <span class="glyphicon glyphicon-trash"  onclick="deletecontact(${contact.contactId}) "></span>
                      </td>
                   </tr>
             </c:forEach>
    </table>
...
<%--jQuery to get the populated values--%>
...
<%--<script type="text/javascript">--%>
    <%--$('#myModal3').dialog({--%>
        ...
        <%--buttons: {--%>
            <%--'Save': function() {--%>
                <%--jQuery("#contactNameUpdate").val(contact.contactName);--%>
                <%--jQuery("#contactEmailUpdate").val(contact.contactEmail);--%>
                <%--jQuery("#phoneNumberUpdate").val(contact.phoneNumber);--%>
                <%--jQuery("#companyNameUpdate").val(contact.c);--%>
            <%--}--%>
        <%--}--%>
    <%--});--%>
<%--</script>--%>
    ...
    function getContactInfo(id) {
        ...
        jQuery.ajax({
            ...
            success:function (data) {
                ...
                jQuery("#contactEmailUpdate").val(data.contactEmail);
